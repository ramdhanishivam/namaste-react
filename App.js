...
import "./App.css";
// App component will have following child components
// 1. Header
    // 1.1 Logo
    // 1.2 Navigation
        // 1.2.1 Home
...
const Header = () => {
    return (
        <div className="header-component" style={styleHeader}>
            <Logo />
            <Navigation />
        </div>
    )
...
const restaurantDataFromSwiggy = [
    {
    "info": {
    "id": "568731",
    "name": "Pizza Hut",
    ...
    "analytics": {
    "context": "seo-data-17e0b1f4-0f4e-44a5-827c-dced8a235351"
    },
    "cta": {},
    ...
    "id": "68034",
    "name": "McDonald's",
    "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2024/4/1/4a8bc67d-8fe4-44db-be5d-1477086cc52b_68034.JPG",
    ...
    "availability": {
    "nextCloseTime": "2024-04-28 01:55:00",
    "opened": true
    },
    "badges": {
    "imageBadges": [
    ...
    "id": "94886",
    "name": "KFC",
    "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2024/4/17/0a394524-ec41-4e42-9b44-a3e4dff3b623_94886.JPG",
    "locality": "Manjusar",
    "areaName": "Manjalpur",
    "costForTwo": "₹400 for two",
    "cuisines": [
    ...
    "cta": {
    "link": "https://www.swiggy.com/restaurants/kfc-manjusar-manjalpur-vadodara-94886",
    "text": "RESTAURANT_MENU",
    "type": "WEBLINK"
    },
    "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
    ...
    "availability": {
    "nextCloseTime": "2024-04-27 22:00:00",
    "opened": true
    },
    "badges": {
    "imageBadges": [
...
const RestaurantContainer = () => {
    return (
        <div className="restaurant-container-component">
            {restaurantDataFromSwiggy.map((restaurant) => (
...
const SocialMediaLinks = () => {
    return (
        <div className="social-media-links-component">
            <ul>
                <li>Facebook</li>
                <li>Instagram</li>
                <li>Twitter</li>
...
const ContactUs = () => {
    return (
        <div className="contact-us-component">
            ...
            <p>Email: shivam@codetasker.com</p>
        </div>
    )
};
